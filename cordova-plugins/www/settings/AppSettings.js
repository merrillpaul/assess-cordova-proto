 ...
 * @constructor
 */
function AppSettings (defaultArgs) {
...
AppSettings.prototype.prepareKey = platform.prepareKey || function (mode, dict, key, value) {
 ...
 */
AppSettings.prototype.fetch = platform.fetch || function (
	...
	var nativeExec = function (resolve, reject) {
		...
		return platform.nativeExec(_successCallback, reject, "AppSettings", "fetch", [args]);
	}
 ...
 */
AppSettings.prototype.store = platform.store || function (
	...
	var nativeExec = function (resolve, reject) {
		...
		return platform.nativeExec (resolve, reject, "AppSettings", "store", [args]);
	}
 ...
 * @param {String} key Key
 */
AppSettings.prototype.remove = platform.remove || function (
	successCallback, errorCallback, dict, key
) {
	...
	var nativeExec = function (resolve, reject) {
		...
		return platform.nativeExec (resolve, reject, "AppSettings", "remove", [args]);
	}
 ...
 * @param {String} key Key
 */
AppSettings.prototype.clearAll = platform.clearAll || function (
	...
	var nativeExec = function (resolve, reject) {
		...
		return platform.nativeExec (resolve, reject, "AppSettings", "clearAll", [args]);
	}
 ...
 * @param {String} key Key
 */
AppSettings.prototype.show = platform.show || function (
successCallback, errorCallback
) {
	...
	var nativeExec = function (resolve, reject) {
		return platform.nativeExec (resolve, reject, "AppSettings", "show", []);
	}
 ...
 * ```
 */
AppSettings.prototype.watch = platform.watch || function (
	...
	var nativeExec = function (resolve, reject) {
		...
		return platform.nativeExec (resolve, reject, "AppSettings", "watch", [args]);
	}
 ...
 * @returns {AppSettings} AppSettings object, bound to that suite
 */

AppSettings.prototype.iosSuite =
AppSettings.prototype.suite =
	function (suiteName) {

	var appPrefs = new AppSettings ({
...
AppSettings.prototype.cloudSync = function () {
	var appPrefs = new AppSettings ({cloudSync: true});
...
AppSettings.prototype.defaults = function () {
	var appPrefs = new AppSettings ();
