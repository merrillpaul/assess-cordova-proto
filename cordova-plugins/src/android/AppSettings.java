...
public class AppSettings extends CordovaPlugin implements OnSharedPreferenceChangeListener {
	...
	protected void pluginInitialize() {
		...
		int resId = context.getResources().getIdentifier("appsettings", "xml", packageName);
	...
	public void onSharedPreferenceChanged (SharedPreferences sharedPreferences, final String key) {
		...
		//	public void run() {
		// TODO: use json
		cdvWebView.loadUrl("javascript:cordova.fireDocumentEvent('settingsChanged',{'key': '" + key + "'})");
		//	}
		//});
	}
	...
	*/
	...
	private boolean showPreferencesActivity (final CallbackContext callbackContext) {
		cordova.getThreadPool().execute(new Runnable() {public void run() {
			...
			try {
				preferenceActivity = Class.forName("com.pearson.assess.cordova.AppSettingsActivity");
				Intent i = new Intent(cordova.getActivity(), preferenceActivity);
				cordova.getActivity().startActivity(i);
				String result = null;
				callbackContext.success(result);
			} catch(ClassNotFoundException e) {
				callbackContext.error("Class com.pearson.assess.cordova.AppSettingsActivity not found. Please run preference generator.");
				e.printStackTrace();
			} catch (Exception e) {
