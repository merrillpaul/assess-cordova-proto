...
/* Generic auth alert title */
KEYS["give.login.auth.error.title"] = "Authentication error";
KEYS["give.login.bad.credentials"] = "Invalid username or password. Please try again.";
KEYS["give.login.generic.error"] = "We're sorry, but we cannot connect to the authentication server right now. If this problem persists, please contact your administrator.";
KEYS["give.login.offline.bad.password"] = "The authentication server is unreachable and the entered password does not match the password stored offline for this user.";
KEYS["give.login.offline.incorrect"] = "Incorrect Offline Credentials Entered";
